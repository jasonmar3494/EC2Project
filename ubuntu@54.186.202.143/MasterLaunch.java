			...
			try{
				...
				do{		
					...
					if (instanceCurRun<nodes){
							...
							ec2launch.withImageId("ami-30c15900");
	
							//launches a jdk installed image
							//ec2launch.withImageId("ami-8026bab0");
							...
							System.out.println("Launching Instance: " + amiKey);
							//keeps track of how many current running instances
							instanceCurRun++;
					}
					//lets 
					if(instanceCurRun % nodes == 0){
						System.out.println("Launching " + nodes + " more threads in 2 minutes");						
	...
	*/
	public static class MMultiServerThread extends Thread{
		...
		public void run(){
			...
			statusMap.put(instanceIP,instanceData);
			try{	
					...
					BufferedReader in = new BufferedReader(new InputStreamReader(socket.getInputStream()));		
						...
						while(taskList.size()>0){
								...
								while(i.hasNext()){
										...
										statusMap.put(instanceIP,curInstance);
										}
									} 	
					}
				out.close();
